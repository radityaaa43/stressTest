...
public class DagTransfer extends Contract {
    ...
    public TransactionReceipt userTransfer(String user_a, String user_b, String amount) {
        final Function function = new Function(
                FUNC_USERTRANSFER, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user_a), 
    ...
    public byte[] userTransfer(String user_a, String user_b, String amount, TransactionCallback callback) {
        final Function function = new Function(
                FUNC_USERTRANSFER, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user_a), 
                new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user_b), 
    ...
    public String getSignedTransactionForUserTransfer(String user_a, String user_b, String amount) {
        final Function function = new Function(
                FUNC_USERTRANSFER, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user_a), 
                new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user_b), 
    ...
    public TransactionReceipt userAdd(String user, String balance) {
        final Function function = new Function(
                FUNC_USERADD, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user), 
    ...
    public byte[] userAdd(String user, String balance, TransactionCallback callback) {
        final Function function = new Function(
                FUNC_USERADD, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user), 
                new org.fisco.bcos.sdk.abi.datatypes.generated.Uint256(balance)), 
    ...
    public String getSignedTransactionForUserAdd(String user, String balance) {
        final Function function = new Function(
                FUNC_USERADD, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user), 
                new org.fisco.bcos.sdk.abi.datatypes.generated.Uint256(balance)), 
    ...
    public TransactionReceipt userSave(String user, String balance) {
        final Function function = new Function(
                FUNC_USERSAVE, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user), 
                new org.fisco.bcos.sdk.abi.datatypes.generated.Uint256(balance)), 
    ...
    public byte[] userSave(String user, String balance, TransactionCallback callback) {
        final Function function = new Function(
                FUNC_USERSAVE, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user), 
                new org.fisco.bcos.sdk.abi.datatypes.generated.Uint256(balance)), 
    ...
    public String getSignedTransactionForUserSave(String user, String balance) {
        final Function function = new Function(
                FUNC_USERSAVE, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user), 
                new org.fisco.bcos.sdk.abi.datatypes.generated.Uint256(balance)), 
    ...
    public TransactionReceipt userDraw(String user, String balance) {
        final Function function = new Function(
                FUNC_USERDRAW, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user), 
                new org.fisco.bcos.sdk.abi.datatypes.generated.Uint256(balance)), 
    ...
    public byte[] userDraw(String user, String balance, TransactionCallback callback) {
        final Function function = new Function(
                FUNC_USERDRAW, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user), 
                new org.fisco.bcos.sdk.abi.datatypes.generated.Uint256(balance)), 
    ...
    public String getSignedTransactionForUserDraw(String user, String balance) {
        final Function function = new Function(
                FUNC_USERDRAW, 
                Arrays.<Type>asList(new org.fisco.bcos.sdk.abi.datatypes.Utf8String(user), 
                new org.fisco.bcos.sdk.abi.datatypes.generated.Uint256(balance)), 
    ...
    public static DagTransfer load(String contractAddress, Client client, CryptoKeyPair credential) {
        return new DagTransfer(contractAddress, client, credential);
    }

    public static DagTransfer deploy(Client client, CryptoKeyPair credential) throws ContractException {
        return deploy(DagTransfer.class, client, credential, getBinary(client.getCryptoSuite()), "");
    }
}
